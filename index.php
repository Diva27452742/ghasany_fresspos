            ...
            <div class="modal-content history-modal-content" style="max-width: 650px;">
                ...
                <div class="member-form-container" style="background: rgba(255,255,255,0.05); padding: 15px; border-radius: 12px; margin-bottom: 15px; border: 1px solid rgba(52,211,153,0.15);">
                    ...
                    <form id="memberForm" style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                        ...
                        <div class="form-group" style="grid-column: span 2;">
                            ...
                            <input type="text" id="memberName" required placeholder="Contoh: Budi, Pak Adi, Sisca" style="width: 100%; padding: 8px 12px; border-radius: 6px; background: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.1); color: #fff; outline: none; font-size: 0.85rem;">
                        </div>
                        
                        <div class="form-group">
                            <label style="font-size: 0.75rem; color: rgba(255,255,255,0.7); display: block; margin-bottom: 4px;">Diskon Member (%)</label>
                            <input type="number" id="memberDiscountPct" min="0" max="100" value="0" style="width: 100%; padding: 8px 12px; border-radius: 6px; background: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.1); color: #fff; outline: none; font-size: 0.85rem;">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="memberDiscountStatus" style="width: 100%; padding: 8px 12px; border-radius: 6px; background: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.1); color: #fff; outline: none; font-size: 0.85rem;">
                        ...
                        <div class="form-group" style="grid-column: span 2;">
                            ...
                            <textarea id="memberNotes" placeholder="Catatan tambahan seperti no telepon, sisa paket, dll" style="width: 100%; height: 50px; padding: 8px 12px; border-radius: 6px; background: rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.1); color: #fff; outline: none; font-size: 0.85rem; resize: none;"></textarea>
                        </div>
                        
                        <div class="form-actions" style="grid-column: span 2; display: flex; justify-content: flex-end; gap: 8px; margin-top: 5px;">
                            <button type="button" id="btnCancelEditMember" style="display: none; padding: 6px 12px; border-radius: 6px; border: 1px solid rgba(255,255,255,0.2); background: transparent; color: #fff; font-size: 0.8rem; cursor: pointer;">Batal</button>
                            <button type="submit" id="btnSaveMember" class="btn-primary" style="padding: 6px 16px; border-radius: 6px; border: none; background: var(--green-500); color: #fff; font-size: 0.8rem; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 6px;">
                ...
                <div class="history-actions" style="display: flex; gap: 10px; align-items: center; margin-bottom: 15px;">
                    <div style="position: relative; flex-grow: 1;">
                        ...
                        <input type="text" id="searchMemberInput" placeholder="Cari member berdasarkan nama atau catatan..." style="width: 100%; padding: 8px 12px 8px 32px; border-radius: 20px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); color: #fff; outline: none; font-size: 0.85rem; transition: all 0.3s ease;">
                    </div>
                    <button id="btnRefreshMembers" class="btn-secondary" style="padding: 8px 14px; border-radius: 20px; font-size: 0.8rem; font-weight: 600;"><i class="fa-solid fa-arrows-rotate"></i> Refresh</button>
                </div>

                <!-- Daftar Member -->
                <div class="history-list" id="memberList" style="max-height: 250px; overflow-y: auto; display: flex; flex-direction: column; gap: 10px; padding-right: 5px;">
